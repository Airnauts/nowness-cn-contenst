...
!function (t) {
  ...
  i.resize = E(u, _), i.scroll = E(u, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), i.redraw = E(), i.location = function (t) {
    ...
    t = t || {}, p = !0, u.triggerHandler("__wf_destroy"), null != t.domready && (d = t.domready), f.each(r, m), i.resize.off(), i.scroll.off(), i.redraw.off(), o = [], a = [], "pending" === k.state() && S();
  ...
  window.tram = function (t) {
    ...
    var l = function (t, e, n) {
      ...
      return function i(s, u) {
        ...
        return d.constructor = c, c.mixin = function (e) {
          ...
          if (f = {}, o(t) ? f = t.call(c, d, h, c, s) : r(t) && (f = t), r(f)) for (var n in f) {
            e.call(f, n) && (d[n] = f[n]);
          }
    ...
    if (j.transition) {
      var q = j.timing.dom;
      if (z.style[q] = f["ease-in-back"][0], !z.style[q]) for (var $ in h) {
        f[$][0] = h[$];
      }
    }
    ...
    var C = e.frame = function () {
      ...
      function d(t, e, i) {
        ...
        for (o in t) {
          s = t[o], o in Q ? (l.transform || (l.transform = {}), l.transform[o] = s) : (w.test(o) && (o = n(o)), o in Z ? l[o] = s : (u || (u = {}), u[o] = s));
        }
      ...
      function n(t, e) {
        ...
        for (n in t) {
          r = (o = Q[n])[0], i = o[1] || n, a = this.convert(t[n], r), e.call(this, i, a, r);
        }
      }
    ...
    e.fallback = function (t) {
      if (!j.transition) return W.fallback = !0;
      W.agentTests.push("(" + t + ")");
    ...
    j.transform && (Z.transform = [R], Q = {
      ...
      skewX: [k],
      skewY: [k]
    }), j.transform && j.backface && (Q.z = [x, "translateZ"], Q.rotateZ = [k], Q.scaleZ = [g], Q.perspective = [y]);
    var J = /ms/,
        V = /s|\./;
    return t.tram = e;
  }(window.jQuery);
  ...
  r.define("forms", t.exports = function (t, e) {
        ...
        !function (e, n) {
          ...
          if (w) l.on("click", function (t) {
            ...
            v.on("click", function () {
              ...
              (i = r.target && r.target.files && r.target.files[0]) && (o.toggle(!1), c.toggle(!1), a.toggle(!0), m.text(i.name), z() || k(n), n.fileUploads[e].uploading = !0, function (e, n) {
                var i = {
                  name: e.name,
                  size: e.size
                };
          ...
          function E(t) {
            var i = t.responseJSON && t.responseJSON.msg,
                r = y;
            "string" == typeof i && 0 === i.indexOf("InvalidFileTypeError") ? r = b : "string" == typeof i && 0 === i.indexOf("MaxFileSizeError") && (r = g), d.text(r), l.removeAttr("data-value"), l.val(""), a.toggle(!1), o.toggle(!0), c.toggle(!0), n.fileUploads[e].uploading = !1, z() || x(n);
          }
    ...
    return c.ready = c.design = c.preview = function () {
      !function () {
        o = t("html").attr("data-wf-site"), s = "https://webflow.com/api/v1/form/" + o, h && s.indexOf("https://webflow.com") >= 0 && (s = s.replace("https://webflow.com", "http://formdata.webflow.com"));
        if (u = "".concat(s, "/signFile"), !(n = t(d + " form")).length) return;
        n.each(y);
      }(), w || a || function () {
        a = !0, l.on("submit", d + " form", function (e) {
          var n = t.data(this, d);
  ...
  i.define("tabs", t.exports = function (t) {
    ...
    function w() {
      n = l && i.env("design"), (e = s.find(h)).length && (e.each(y), i.env("preview") && !m && e.each(b), g(), i.redraw.on(o.redraw));
    }
    ...
    function x(e, n) {
      ...
      if (s !== e.current) {
        ...
        var h = t(u),
            w = t(l);
        if (n.immediate || r.immediate) return h.addClass(p).each(v.intro), w.removeClass(p), void (m || i.redraw.up());
        w.length && r.outro ? (w.each(v.outro), a(w).add("opacity " + r.outro + "ms " + o, {
          fallback: c
        }).start({
          opacity: 0
        }).then(g)) : g();
